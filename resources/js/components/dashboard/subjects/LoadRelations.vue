        ...
        <v-card class="mx-auto" elevation="0">
            <div class="pb-4 mx-4">
                ...
                <v-card-title class="text-h5">
                    <p class="mx-auto">CARGAR SUSCRIPCIONES</p>
                </v-card-title>
                        ...
                        <v-stepper-content step="2">
                            <template v-if="data.length > 0">
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" sm="6" class="my-1">
                                        <v-btn class="txt_white bk_blue" block @click.stop="loadRelations()">
                                            Cargar datos
...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Código de la materia', value: 'subject', align: 'center' },
        ],
        login_user: [],
        search: '',
        search_fail: '',
