                                        ...
                                        <v-row>
                                            <v-col>
                                                <v-autocomplete v-model="form_information.subject"
                                                    ...
                                                    clear-icon="cancel" label="Código del curso *" tabindex="3" dense
                    ...
                    <v-tab-item>
                        <div class="px-4 py-4">
                            ...
                            <template v-if="editorData != topic.body">
                                <v-btn class="txt_white bk_green mt-2" block @click.stop="saveBody()">
                                    <v-icon left>save</v-icon>
                                    Guardar
                                </v-btn>
                            </template>
                    ...
                    <v-tab-item>
                        <div class="px-4 py-4">
                            ...
                            <div>
                                ...
                                <v-btn class="txt_white bk_red" block @click.stop="deleteTopic()">
                                    <v-icon left>delete</v-icon>
                                    Eliminar tema
                                </v-btn>
                            </div>
                ...
                await this.axios.get('/api/topic/' + this.address)
                    .then(response => {
                        ...
                        if (!items.topic) {
                            ...
                            // Subject
                            if (items.subject) {
                                this.form_information.subject = items.subject;
                                this.form_information.copy_subject = items.subject;
                            }
                            else {
