<template>
    <v-main class="ma-2">
        ...
        <v-card class="mx-auto" elevation="0">
            <div class="pb-4 mx-4">
                <v-btn class="mr-4 mt-2" text small @click.stop="returnTags()">
                ...
                <v-stepper class="mx-auto" v-model="step" alt-labels max-width="1100">
                    ...
                    <v-stepper-items>
                        ...
                        <v-stepper-content step="2">
                            <template v-if="data.length > 0">
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" sm="6" class="my-1">
                                        <v-btn class="txt_white bk_blue" block @click.stop="loadTags()">
                                            Cargar datos
                        ...
                        <v-stepper-content step="3">
                            ...
                            <v-btn class="txt_white bk_green" block @click.stop="returnTags()">
                                <v-icon left>keyboard_double_arrow_left</v-icon>
                                Terminar
                            </v-btn>
                        </v-stepper-content>
...
export default {
    ...
    data: () => ({
        ...
        headers: [
            { text: 'Etiquetas (Nombres)', value: 'name', align: 'center' },
        ],
        login_user: [],
        search: '',
        search_fail: '',
