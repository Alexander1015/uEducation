              ...
              case 0:
                ...
                return _this.$swal({
                  ...
                  if (result.isConfirmed) {
                    ...
                    var _iterator = _createForOfIteratorHelper(_this.selected),
                        _step;
                    ...
                    _this.axios.post('/api/getusr/' + _this.address, data).then(function (response) {
                      var title = "Error";
                      var icon = "error";
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                _context2.next = 6;
                return _this2.axios.get('/api/getusr').then(function (response) {
                  _this2.all_users = response.data;
                })["catch"](function (error) {
                  console.log(error);
                });
              ...
              case 6:
                _context2.next = 8;
                return _this2.axios.get('/api/subject/' + _this2.address).then(function (response) {
                  ...
                  if (!item.subject.name) {
                    ...
                    // Subject
                    _this2.subject = item.subject;
                    _this2.form_information.name = _this2.subject.name;

                    if (_this2.subject.img) {
                      _this2.prev_img.url_img = "/img/subjects/" + _this2.subject.img + "/index.png";
                      _this2.prev_img.lazy_img = "/img/subjects/" + _this2.subject.img + "/lazy.png";
                    }

                    _this2.form_information.img = null;
                    _this2.form_information.img_new = 0;
                    if (_this2.subject.status == 0) _this2.form_status.status = "Deshabilitado";else if (_this2.subject.status == 1) _this2.form_status.status = "Habilitado"; // Topics

                    _this2.topics = _this2.topics_copy = item.topics;
              ...
              case 0:
                ...
                return _this3.$swal({
                  ...
                  if (result.isConfirmed) {
                    ...
                    _this3.axios.post('/api/subject/' + _this3.address, data).then(function (response) {
                      var title = "Error";
                      var icon = "error";
              ...
              case 0:
                ...
                return _this4.$swal({
                  ...
                  if (result.isConfirmed) {
                    ...
                    var _iterator2 = _createForOfIteratorHelper(_this4.topics),
                        _step2;
                    ...
                    _this4.axios.post('/api/subject/gettopics/' + _this4.address, data).then(function (response) {
                      var title = "Error";
                      var icon = "error";
              ...
              case 0:
                ...
                return _this5.$swal({
                  ...
                  if (result.isConfirmed) {
                    ...
                    var data = new FormData();
                    var type = 3;
                    if (_this5.form_status.status == "Habilitado") type = 1;else if (_this5.form_status.status == "Deshabilitado") type = 0;
                    data.append('status', type);
                    data.append('_method', "put");

                    _this5.axios.post('/api/subject/status/' + _this5.address, data).then(function (response) {
                      var title = "Error";
                      var icon = "error";
              ...
              case 0:
                ...
                return _this6.$swal({
                  ...
                  if (result.isConfirmed) {
                    ...
                    _this6.axios["delete"]('/api/subject/' + _this6.address).then(function (response) {
                      var title = "Error";
                      var icon = "error";
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c("v-text-field", {
                                          ...
                                          model: {
                                            value: _vm.search_all_users,
                                            callback: function ($$v) {
                                              _vm.search_all_users = $$v
                                            },
                                            expression: "search_all_users",
                                          },
                                        }),
                                      ],
                                      1
