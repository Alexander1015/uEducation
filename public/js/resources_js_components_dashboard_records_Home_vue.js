        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                _context.next = 8;
                return _this2.axios.get('/api/record').then(function (response) {
                  _this2.data_year = response.data;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                data = new FormData();
                data.append('period', _this3.period);
                data.append('year', _this3.year);
                _context2.next = 8;
                return _this3.axios.post('/api/record/list', data).then(function (response) {
                  var items = response.data;
                  _this3.data = items.data;
                  _this3.data_subject = items.subjects;
                  _this3.view = true;
                      ...
                      [
                        _c("v-autocomplete", {
                          attrs: {
                            ...
                            clearable: "",
                            "clear-icon": "cancel",
                            label: "Buscar por ciclo inscrito",
                            tabindex: "1",
                            dense: "",
                            loading: _vm.overlay,
                            "no-data-text":
                      ...
                      [
                        _c("v-autocomplete", {
                          attrs: {
                            ...
                            clearable: "",
                            "clear-icon": "cancel",
                            label: "Buscar por año de registro",
                            tabindex: "2",
                            dense: "",
                            loading: _vm.overlay,
                            "no-data-text":
                    ...
                    _c(
                      ...
                      [
                        _c(
                                ...
                                fn: function (ref) {
                                  ...
                                  return [
                                    _c(
                                      ...
                                      [_c("v-icon", [_vm._v("manage_search")])],
                                      1
                                    ),
                                  ]
                                },
                          ...
                          [
                            _vm._v(" "),
                            _c("span", [_vm._v("Buscar registros")]),
                          ]
                        ),
                      ],
                      1
